...
// Example:
let foods = ["pizza", "hamburgers", "chips", "salad"];
...
function printAboutMe(name, favoriteNumber) {
...
let printFavoriteNumber = (favNumber) => console.log(favNumber);
// How to bypass TS
...
let myNumber = 67; // The | is used to separate the different allowed types
